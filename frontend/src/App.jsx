            ...
            <>
              ...
              <header className="bg-[#fabd00] fixed top-0 left-0 right-0 w-full max-w-[480px] z-50 flex items-center justify-between px-container-margin-mobile h-16 border-b border-[#fabd00] mx-auto text-white">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-display text-base font-black tracking-tight text-white flex items-center gap-0">
                    Cizquake Expre
                    ...
                    <span className="material-symbols-outlined text-white text-base font-black leading-none -ml-1" style={{ fontVariationSettings: "'FILL' 1" }}>bolt</span>
                  </span>
                </div>
